...
const Navbar = () => {
  ...
  return (
      <div className='flex items-center justify-between py-4'>
          <Link to='/'> <img src={assets.logo} alt="" className='w-26 sm:32 lg:40' /></Link>
          <div>
              {
                  user ? <div className='flex item-center gap-2 sm:gap-3'>
                        <button onClick={()=>navigate('/buy')} className='flex item-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                          ...
                          <p className='text-xs sm:text-5m font-medium text-gray-600'>credits left : 5</p>
                      </button>
                        <p className='text-gray-600 max-sm:hidden pl-4'>Hi,GK !</p>
